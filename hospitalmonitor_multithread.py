#multithreading in a hospital monitoring system
#run in three concurrent threads(sensor data reading,doctor notification,data logging)
...
def read_sensor_data(): 
    for i in range(5): 
        ...
        sensor_placeholder.markdown( f"**Sensor Reading {i+1}:** Heart Rate = `{heart_rate}` bpm {temperature}°C" )
        time.sleep(2)
